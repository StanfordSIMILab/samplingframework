...
## set to true to run whole pipeline on randomly sampled dataset versus false runs it on the diverse sample dataset
USE_RANDOM=False
...
for epoch in range(NUM_EPOCHS):
    ...
    torch.save(
        model.state_dict(),
        f"mask2former_models/mask2former_tuned_cseg_epoch{epoch}.pth",
    )
